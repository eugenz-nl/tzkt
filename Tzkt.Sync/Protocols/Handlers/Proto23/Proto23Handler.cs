...
using Tzkt.Sync.Protocols.Proto23;
...
namespace Tzkt.Sync.Protocols
{
    class Proto23Handler : ProtocolHandler
    {
        ...
        public Proto23Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto23Handler> logger, IMetrics metrics)
