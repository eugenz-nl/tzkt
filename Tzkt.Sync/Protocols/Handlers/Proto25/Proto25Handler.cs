...
using Tzkt.Sync.Protocols.Proto25;
...
namespace Tzkt.Sync.Protocols
{
    class Proto25Handler : ProtocolHandler
    {
        ...
        public Proto25Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto25Handler> logger, IMetrics metrics)
