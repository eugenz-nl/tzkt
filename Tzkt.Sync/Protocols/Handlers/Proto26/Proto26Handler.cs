...
using Tzkt.Sync.Protocols.Proto26;

namespace Tzkt.Sync.Protocols
{
    class Proto26Handler : ProtocolHandler
    {
        public override IDiagnostics Diagnostics { get; }
        public override IHelpers Helpers { get; }
        public override IValidator Validator { get; }
        public override IRpc Rpc { get; }
        public override string VersionName => "a026_026";
        public override int VersionNumber => 26;

        public Proto26Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto26Handler> logger, IMetrics metrics)
