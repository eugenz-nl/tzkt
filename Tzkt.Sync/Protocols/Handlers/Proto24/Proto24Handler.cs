...
namespace Tzkt.Sync.Protocols
{
    class Proto24Handler : ProtocolHandler
    {
        ...
        public Proto24Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto24Handler> logger, IMetrics metrics)
